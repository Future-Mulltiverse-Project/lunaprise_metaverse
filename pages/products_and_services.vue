<template>
  ...
  <section v-else class="font-satoshi">
    <AboutProductsAndPackages @goToPricing="goToSection = 'pricing'" />
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Learn more about our products and services at Lunaprise Metaverse.' }
  ]
});
