        ...
        >
          ...
          >
            <div class="justify-center items-center">
              ...
              >
                <div class="flex flex-col font-bold text-gold-light items-center justify-center">
          <p class="text-xl lg:text-4xl leading-tight tracking-wide lg:tracking-normal">
                  ...
                  <div class="flex justify-center items-center">
                    ...
                    >
                        ...
                        >
                          ...
                          >
                            <p>ENTER <span class="text-gold-light">LUNAPRISE</span>
                            <br />
                            IN THE MULTIVERSE</p>
                          </div>
                          <DegreeGreyIcon
          ...
          <div class="flex flex-col md:flex-row justify-center items-center gap-4">
            ...
            >
              <button
                ...
                :class="
                  { 'cursor-not-allowed' : isConnecting}
